...
import { InsertNotebook, Notebook, notebooks } from '@/db/schema/notebooks';
...
export const createNotebook = async (values: InsertNotebook) => {
    try {
        ...
        return { success: false, message: 'Failed to create a notebook' };
    }
};
...
export const getNotebooks = async () => {
    try {
        ...
        const notebooksByUser: Notebook[] = await db.query.notebooks.findMany({
